                          ...
                          <div class="col-md-6 col-6">
                            <div class="form-group pb-3">
                              <label for="">Postal code</label>
                                <input id="postcode" type="text" name="postal_code" class="form-control" readonly value="{{ old('postal_code') }}">
                            </div>
                          </div>
                            <div class="col-md-6 col-6">
                                <div class="form-group pb-3">
                                    <label for="">Country*</label>
                                    <select name="country" disabled id="country" class="form-control" required="">
