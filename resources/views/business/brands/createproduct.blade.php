              ...
              <div class="col-md-12 p-5 bg-light">
                ...
                <div class="card">
                  <div class="card-body pb-5">
                    ...
                    <form action="{{ route('savebrandproduct') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                                  ...
                                  @foreach($genetics as $genetic)
                                    <div class="col-md-2 mb-3">
                                      <div class="form-check">
                                        <input class="form-check-input" type="radio" name="genetic_id" id="{{ $genetic->name }}" value="{{ $genetic->id }}" required="">
